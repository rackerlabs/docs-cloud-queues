...
html_title = 'Rackspace Cloud Queues v1 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Queues v1 API'
...
man_pages = [
    (master_doc, 'Rackspace Cloud Queues API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-queues', 'Rackspace Cloud Queues API Documentation',
   'Rackspace', 'docs-cloud-queues',
   'Learn about using the Cloud Queues service.', 'Miscellaneous'),
]
